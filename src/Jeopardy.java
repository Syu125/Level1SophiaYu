...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel header = createHeader("Engineering");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == (firstButton)) {
			...
			// change.
			askQuestion("What is a truss usually composed of?", "triangles", 200);
		}
		// Or if the buttonPressed was the secondButton
		else if (arg0.getSource() == (secondButton)) {

			// Call the askQuestion() method with a harder question
			askQuestion("What is the equation you use to determine if a truss structure is determinate?", "2J=M+R",
					400);
		}
