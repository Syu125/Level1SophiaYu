public class Backpack {
	...
	public static void main(String[] args) {
		...
		p1.write("Now you can write: I'm tired..., on your notebooks and papers!");
		myBackpack.putInBackpack(p1);
		System.out.println();

		Ruler r1 = new Ruler();
		r1.measure();
		myBackpack.putInBackpack(r1);
		System.out.println();

		Textbook t1 = new Textbook();
		t1.read();
		myBackpack.putInBackpack(t1);
		System.out.println();

		myBackpack.goToSchool();
