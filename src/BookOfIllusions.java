...
JFrame frame=new JFrame();
	private void createBook() {
		...
		String illusion1="Illusion2.jpg";
		// 6. create a variable of type "JLabel" but don’t initialize it yet
		JLabel labelforIllusion1;
		// 7. use the "loadImage..." methods below to initialize your JLabel
		labelforIllusion1=loadImageFromComputer(illusion1);
		// 8. add your JLabel to the frame
		frame.add(labelforIllusion1);
	...
	public void mousePressed(MouseEvent e) {
		...
		JLabel labelforIllusion2;
		labelforIllusion2=loadImageFromComputer(illusion2);
		frame.add(labelforIllusion2);
		// 14. pack the frame
		frame.pack();
	}
